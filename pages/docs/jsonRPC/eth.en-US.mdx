...
These methods are used for real-time events through subscriptions. See the <a href="https://geth.ethereum.org/docs/rpc/pubsub" title="subscription documentation">subscription documentation</a> for more information.
...
With a synced Rinkeby node with RPC exposed on localhost (`geth --rinkeby --http`) we can make a call against the live <a href="https://rinkeby.etherscan.io/address/0xebe8efa441b9302a0d7eaecc277c09d20d684540" title="Checkpoint Oracle">Checkpoint Oracle</a>, but override its byte code with our own version that has an accessor for the voting threshold field:
