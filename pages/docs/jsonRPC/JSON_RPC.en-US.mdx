...
title: JSON-RPC
---
Geth supports all standard web3 JSON-RPC APIs. You can find documentation for these APIs on <a href="https://github.com/ethereum/wiki/wiki/JSON-RPC" title="the Ethereum Wiki JSON-RPC page">the Ethereum Wiki JSON-RPC page</a>.
...
Example: if you want to use <a href="https://remix.ethereum.org/#optimize=false&runs=200&evmVersion=null&version=soljson-v0.8.4+commit.c7e474f2.js" title="Remix">Remix</a> with geth, allow requests from the remix domain.
