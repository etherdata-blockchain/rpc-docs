...
which will allow you to have a fine grained control over your Geth instance,
...
the absolute path the running Geth node currently uses 
...
the information known about the running Geth node at the networking 
...
application protocols (e.g. `eth`, `les`, `shh`, `bzz`).
