...
Returns all the Etherdata account addresses of all keys in the key store.
...
The sign method calculates an Etherdata specific signature with: `sign(keccack256("\x19Etherdata Signed Message:\n" + len(message) + message)))`.
