...
References: <a href="https://github.com/etherdata/wiki/wiki/RLP" title="RLP">RLP</a>
...
Similar to <a href="https://Getd.etherdata.org/docs/rpc/ns-debug#debug_traceblock" title="debug_traceBlock">debug_traceBlock</a>,`traceBlockByNumber` accepts a block number and will replay the block that is already present in the database.  
References: <a href="https://github.com/etherdata/wiki/wiki/RLP" title="RLP">RLP</a>

## debug_traceBlockByHash

Similar to <a href="https://Getd.etherdata.org/docs/rpc/ns-debug#debug_traceblock" title="debug_traceBlock">debug_traceBlock</a>,`traceBlockByHash` accepts a block hash and will replay the block that is already present in the database.  
References: <a href="https://github.com/etherdata/wiki/wiki/RLP" title="RLP">RLP</a>

## debug_traceBlockFromFile

Similar to <a href="https://Getd.etherdata.org/docs/rpc/ns-debug#debug_traceblock" title="debug_traceBlock">debug_traceBlock</a>,`traceBlockFromFile` accepts a file containing the RLP of the block.  
References: <a href="https://github.com/etherdata/wiki/wiki/RLP" title="RLP">RLP</a>
...
The `debug_traceCall` method lets you run an `etd_call` on top of a given block. The block can be specified either by hash or by number. It takes the same input object as a `etd_call`. It returns the same output as `debug_traceTransaction`. A tracer can be specified as a third argument, similar to `debug_traceTransaction`.
...
- `data`: `DATA` - (optional) Hash of the method signature and encoded parameters. For details see Etherdata Contract ABI in the Solidity documentation
